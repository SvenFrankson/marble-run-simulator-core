...
declare namespace MarbleRunSimulatorCore {
    class MachineCollider {
        ...
        bouncyness: number;
        randomness: number;
        onImpact: (hit: Mummu.IIntersection) => void;
...
declare namespace MarbleRunSimulatorCore {
    class LargeBitSplit extends MachinePart {
        private _animatePivot;
        pivot: BABYLON.Mesh;
        stepLeft: BABYLON.Mesh;
        stepRight: BABYLON.Mesh;
        axisZMin: number;
        axisZMax: number;
        clicSound: BABYLON.Sound;
...
declare namespace MarbleRunSimulatorCore {
    ...
    class BBBouncer extends BABYLON.Mesh {
        ...
        thicknessRadius: number;
        body: BABYLON.Mesh;
        plateTop: BABYLON.Mesh;
        plateBottom: BABYLON.Mesh;
    ...
    class BlackBoard extends MachinePart {
        ...
        private _addBoard;
        private static _createMiniatureShape;
        constructor(machine: Machine, prop: IMachinePartProp);
        static PropToPartName(prop: IMachinePartProp): string;
        ...
        clampLocalPositionOnBBox(pt: BABYLON.Vector3, radius: number): BABYLON.Vector3;
...
declare namespace MarbleRunSimulatorCore {
    class Star extends MachinePart {
        starMesh: BABYLON.Mesh;
        constructor(machine: Machine, prop: IMachinePartProp);
        static PropToPartName(prop: IMachinePartProp): string;
        protected instantiateMachineSpecific(): Promise<void>;
        onBeforeApplyingSelectorMeshLogicVertexData(selectorMeshLogicVertexDatas: BABYLON.VertexData[]): void;
