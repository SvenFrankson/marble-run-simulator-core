    ...
    class TemplateManager {
        ...
        getTemplate(partName, mirrorX, mirrorZ) {
            ...
            if (!data) {
                if (partName.startsWith("curb_")) {
                    ...
                    let h = parseInt(partName.split("_")[1].split(".")[1]);
                    let d = parseInt(partName.split("_")[1].split(".")[2]);
                    data = MarbleRunSimulatorCore.RampV2.GenerateTemplate(l, h, d, false, false);
                }
        ...
        getTemplateByProp(baseName, prop) {
            ...
            if (baseName === "curb") {
                ...
                partName = MarbleRunSimulatorCore.RampV2.PropToPartName(prop);
            }
...
var MarbleRunSimulatorCore;
(function (MarbleRunSimulatorCore) {
    function DrawMiniature(lines, canvas) {
        let picSize = 512;
...
(function (MarbleRunSimulatorCore) {
    class Controler extends MarbleRunSimulatorCore.MachinePart {
        ...
        constructor(machine, prop) {
            ...
            wireVertical0.path = [new BABYLON.Vector3(0, Controler.pivotL, -dz - 2 * MarbleRunSimulatorCore.tileSize), new BABYLON.Vector3(0, -Controler.pivotL, -dz - 2 * MarbleRunSimulatorCore.tileSize)];
            let wireVertical1 = new MarbleRunSimulatorCore.Wire(this);
            wireVertical1.colorIndex = 5;
            wireVertical1.parent = this.pivotPass;
            wireVertical1.path = [new BABYLON.Vector3(0, Controler.pivotL, dz - 2 * MarbleRunSimulatorCore.tileSize), new BABYLON.Vector3(0, -Controler.pivotL, dz - 2 * MarbleRunSimulatorCore.tileSize)];
        ...
        async instantiateMachineSpecific() {
            ...
            let axisControlerVertexData = BABYLON.CreateCylinderVertexData({ height: MarbleRunSimulatorCore.tileSize + this.wireGauge * 1.2, diameter: 0.001 });
            Mummu.RotateVertexDataInPlace(axisControlerVertexData, q);
            Mummu.TranslateVertexDataInPlace(axisControlerVertexData, new BABYLON.Vector3(0, MarbleRunSimulatorCore.tileHeight, 0.5 * MarbleRunSimulatorCore.tileSize));
...
(function (MarbleRunSimulatorCore) {
    class RampV2 extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(l, h, d, pipeVersion, woodVersion) {
            let template = new MarbleRunSimulatorCore.MachinePartTemplate();
...
(function (MarbleRunSimulatorCore) {
    class Shooter extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(h, n) {
            ...
            template.maxAngle = Math.PI / 16;
            template.initialize();
            template.miniatureShapes.push(MarbleRunSimulatorCore.MiniatureShape.MakeNGon(new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.4, 0.06, 0), 0.025, BABYLON.Axis.Y, 16));
            template.miniatureShapes.push(MarbleRunSimulatorCore.MiniatureShape.MakeNGon(new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.4, 0.04, 0), 0.015, BABYLON.Axis.Y, 16));
            template.miniatureShapes.push(MarbleRunSimulatorCore.MiniatureShape.MakeNGon(new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.4, 0.035, 0), 0.015, BABYLON.Axis.Y, 16));
            return template;
        }
        dispose() {
            super.dispose();
