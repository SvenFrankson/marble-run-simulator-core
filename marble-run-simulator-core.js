...
(function (MarbleRunSimulatorCore) {
    ...
    MarbleRunSimulatorCore.tileWidth = 0.15;
        ...
        getTemplate(partName, mirrorX, mirrorZ) {
            ...
            if (!data) {
                if (partName.startsWith("uturn-")) {
                    ...
                    let h = parseInt(partName.split("-")[1].split(".")[1]);
                    let d = parseInt(partName.split("-")[1].split(".")[2]);
                    data = MarbleRunSimulatorCore.Snake.GenerateTemplate(w, h, isFinite(d) ? d : 1, mirrorX, mirrorZ);
                }
                    ...
                    let h = parseInt(partName.split("-")[1].split(".")[1]);
                    let n = parseInt(partName.split("-")[1].split(".")[2]);
                    data = MarbleRunSimulatorCore.Spiral.GenerateTemplate(w, h, n, mirrorX, mirrorZ);
                }
...
(function (MarbleRunSimulatorCore) {
    class Elevator extends MarbleRunSimulatorCore.MachinePart {
        constructor(machine, prop) {
            ...
            this.wheels[0].position.copyFromFloats(0.03 * x, -MarbleRunSimulatorCore.tileHeight * (this.h + 0.35), 0);
        ...
        static GenerateTemplate(h, mirrorX) {
            ...
            template.trackTemplates[0].trackpoints = [
                ...
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.1, -MarbleRunSimulatorCore.tileHeight * (h + 0.15), 0), dir),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0, -MarbleRunSimulatorCore.tileHeight * (h + 0.35), 0), dir),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0 + 0.01, -MarbleRunSimulatorCore.tileHeight * (h + 0.35) + 0.01, 0), n),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0 + 0.01, 0 - MarbleRunSimulatorCore.tileHeight, 0), n),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-0.005, 0.035 - MarbleRunSimulatorCore.tileHeight, 0), new BABYLON.Vector3(-1, 1, 0).normalize(), new BABYLON.Vector3(-1, -1, 0).normalize()),
            ];
            template.trackTemplates[0].drawEndTip = true;
            template.trackTemplates[1] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[1].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.5, -MarbleRunSimulatorCore.tileHeight, 0), dirLeft), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(-0.008, -MarbleRunSimulatorCore.tileHeight * 0.5, 0), dirRight)];
            if (mirrorX) {
...
(function (MarbleRunSimulatorCore) {
    class GravityWell extends MarbleRunSimulatorCore.MachinePart {
        constructor(machine, prop) {
            ...
            this.setTemplate(this.machine.templateManager.getTemplate(partName, prop.mirrorX));
            this.wellPath = [new BABYLON.Vector3(0.012, 0, 0), new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.5, MarbleRunSimulatorCore.tileHeight * 0.9, 0)];
            ...
            this.wellPath.push(new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.5, MarbleRunSimulatorCore.tileHeight * 1, 0)), (this.wellMesh = BABYLON.MeshBuilder.CreateLathe("gravity-well-mesh", { shape: this.wellPath, tessellation: 32, sideOrientation: BABYLON.Mesh.DOUBLESIDE }));
            this.wellMesh.material = machine.game.materials.getMetalMaterial(0);
            this.wellMesh.position.copyFromFloats(0, -MarbleRunSimulatorCore.tileHeight * 1.6, -MarbleRunSimulatorCore.tileDepth);
            this.wellMesh.parent = this;
            let wireTop = BABYLON.MeshBuilder.CreateTorus("wire-top", { diameter: MarbleRunSimulatorCore.tileWidth * 0.5 * 2, thickness: this.wireSize, tessellation: 32 });
        ...
        static GenerateTemplate(mirrorX) {
            ...
            template.trackTemplates[0].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.5, 0, 0), MarbleRunSimulatorCore.Tools.V3Dir(90)), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.1, -0.01, 0), MarbleRunSimulatorCore.Tools.V3Dir(120))];
            template.trackTemplates[1] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[1].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.1, -MarbleRunSimulatorCore.tileHeight * h + 0.025, -MarbleRunSimulatorCore.tileDepth), MarbleRunSimulatorCore.Tools.V3Dir(150)), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.5, -MarbleRunSimulatorCore.tileHeight * h, -MarbleRunSimulatorCore.tileDepth), MarbleRunSimulatorCore.Tools.V3Dir(90))];
            template.trackTemplates[1].drawStartTip = true;
            if (mirrorX) {
                template.mirrorXTrackPointsInPlace();
            }
    ...
    class Join extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(mirrorX) {
            ...
            template.trackTemplates[0].trackpoints = [
                ...
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth / 3, 0, 0), dir),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth / 3, -MarbleRunSimulatorCore.tileHeight, 0), dir),
            ...
            template.trackTemplates[1] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[1].colorIndex = 1;
            template.trackTemplates[1].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.5, 0, 0), dir.scale(-1)), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.25, -MarbleRunSimulatorCore.tileHeight * 0.25, 0), dirJoin)];
            let center = new BABYLON.Vector3(0.0135, 0.0165, 0);
            let r = 0.02;
            template.trackTemplates[2] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[2].colorIndex = 2;
            template.trackTemplates[2].trackpoints = [
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[2], center.add(new BABYLON.Vector3((-r * Math.sqrt(3)) / 2, (-r * 1) / 2, 0)), new BABYLON.Vector3(0.5, -Math.sqrt(3) / 2, 0), new BABYLON.Vector3(-1, 0, 0)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[2], center.add(new BABYLON.Vector3(0, -r, 0))),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[2], center.add(new BABYLON.Vector3((r * Math.sqrt(3)) / 2, (-r * 1) / 2, 0)), new BABYLON.Vector3(0.5, Math.sqrt(3) / 2, 0), new BABYLON.Vector3(1, 0, 0)),
            ];
            template.trackTemplates[2].drawStartTip = true;
            template.trackTemplates[2].drawEndTip = true;
...
(function (MarbleRunSimulatorCore) {
    class Loop extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(w, d, n, mirrorX, mirrorZ) {
            ...
            let r = MarbleRunSimulatorCore.tileWidth * 0.5 * 0.7;
...
(function (MarbleRunSimulatorCore) {
    class UTurnSharp extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(mirrorX, mirrorZ) {
            ...
            template.trackTemplates[0] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[0].trackpoints = [
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-0.075, 0, 0), new BABYLON.Vector3(1, 0, 0)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0.0193, -0.0084, 0.0)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0.0518, 0.0057, -0.0046)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0.0638, 0.0181, -0.0256)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0.0586, 0.0099, -0.0448)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0.0454, -0.0086, -0.0519)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(0.0262, -0.0253, -0.0454)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-0.0152, -0.0301, 0), new BABYLON.Vector3(-1, 0, 0)),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-0.075, -0.03, 0), new BABYLON.Vector3(-1, 0, 0)),
            ];
            if (mirrorX) {
                template.mirrorXTrackPointsInPlace();
            }
    ...
    class Spiral extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(w, h, n, mirrorX, mirrorZ) {
            ...
            for (let n = 0; n <= 6 * nSpirals; n++) {
                ...
                template.trackTemplates[0].trackpoints.push(new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(f * (xCenterEnd - xCenterStart) + xCenterStart + sina * r, f * (heightEnd - heightStart) + heightStart, (cosa - 1) * r), dir));
            }
...
(function (MarbleRunSimulatorCore) {
    class Split extends MarbleRunSimulatorCore.MachinePart {
        constructor(machine, prop) {
            ...
            anchor.position.copyFromFloats(0, -MarbleRunSimulatorCore.tileHeight, 0);
            anchor.parent = this;
            ...
            this.pivot.position.copyFromFloats(0, -MarbleRunSimulatorCore.tileHeight, 0);
        ...
        static GenerateTemplate(mirrorX) {
            ...
            let n = new BABYLON.Vector3(0, 1, 0);
            n.normalize();
            let pEndLeft = new BABYLON.Vector3(0, -MarbleRunSimulatorCore.tileHeight, 0);
            ...
            template.trackTemplates[0] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[0].colorIndex = 0;
            template.trackTemplates[0].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.5, 0, 0), dir), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[0], pEndLeft.subtract(dirEnd.scale(0.001)), dirEnd)];
            template.trackTemplates[1] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[1].colorIndex = 2;
            template.trackTemplates[1].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileWidth * 0.5, -MarbleRunSimulatorCore.tileHeight * template.h, 0), dir), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(-Split.pivotL / Math.SQRT2, -MarbleRunSimulatorCore.tileHeight - Split.pivotL / Math.SQRT2 - 0.0015 * 1.5, 0), dirEnd.multiplyByFloats(1, -1, 1))];
            template.trackTemplates[2] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[2].colorIndex = 3;
            template.trackTemplates[2].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[2], new BABYLON.Vector3(Split.pivotL / Math.SQRT2, -MarbleRunSimulatorCore.tileHeight - Split.pivotL / Math.SQRT2 - 0.0015 * 1.5, 0), dirEnd), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[2], new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.5, -MarbleRunSimulatorCore.tileHeight * template.h, 0), dir)];
            template.trackTemplates[3] = new MarbleRunSimulatorCore.TrackTemplate(template);
            template.trackTemplates[3].colorIndex = 1;
            template.trackTemplates[3].trackpoints = [new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[3], new BABYLON.Vector3(MarbleRunSimulatorCore.tileWidth * 0.5, 0, 0), dir.multiplyByFloats(-1, 1, 1)), new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[3], pEndLeft.subtract(dirEnd.scale(0.001)).multiplyByFloats(-1, 1, 1), dirEnd.multiplyByFloats(-1, 1, 1))];
            ...
            template.trackTemplates[4].trackpoints = [
                ...
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[4], new BABYLON.Vector3(0, -0.003, 0)),
...
(function (MarbleRunSimulatorCore) {
    class Wall extends MarbleRunSimulatorCore.MachinePart {
        ...
        static GenerateTemplate(h, d, mirrorX) {
            ...
            template.zExtendable = true;
            template.xMirrorable = true;
            let r = MarbleRunSimulatorCore.tileWidth * 0.5;
