                            ...
                            part.tracks.forEach(track => {
                                if (track instanceof MarbleRunSimulatorCore.PipeTrack || track instanceof MarbleRunSimulatorCore.WoodTrack) {
                                    if (track instanceof MarbleRunSimulatorCore.WoodTrack) {
                                        let cols = Mummu.SphereExtrudeIntersections(this.position, this.radius, track.absolutePath, track.absoluteNormals, track.shape);
                                        cols.forEach(col => {
                                            if (col.hit) {
                                                //this.setLastHit(wire, col.index);
                                                let colDig = col.normal.scale(-1);
                                    ...
                                    else if (track instanceof MarbleRunSimulatorCore.PipeTrack) {
                                        let r = 0.011;
    ...
    class Wire extends BABYLON.Mesh {
        ...
        async instantiate(color = 0) {
            ...
            if (!Wire.DEBUG_DISPLAY) {
                ...
                if (this.part.machine.toonOutlineRender) {
...
(function (MarbleRunSimulatorCore) {
    ...
    class MachinePart extends BABYLON.Mesh {
        constructor(machine, prop, isPlaced = true) {
            ...
            this.localAABBBaseMin = new BABYLON.Vector3(-MarbleRunSimulatorCore.tileSize * 0.5, -MarbleRunSimulatorCore.tileHeight * 0.5, -MarbleRunSimulatorCore.tileSize * 0.5);
            this.localAABBBaseMax = new BABYLON.Vector3(MarbleRunSimulatorCore.tileSize * 0.5, MarbleRunSimulatorCore.tileHeight * 0.5, MarbleRunSimulatorCore.tileSize * 0.5);
        ...
        updateSelectorMeshVisibility() {
            if (this.selectorBodyDisplay) {
                if (this._selected) {
                    ...
                    if (this.machine.toonOutlineRender) {
                        this.setOutlineParams(true, MarbleRunSimulatorCore.UI3DConstants.toonOutlineWidth, MarbleRunSimulatorCore.UI3DConstants.toonOutlineBaseColor);
                    }
                    else {
...
(function (MarbleRunSimulatorCore) {
    ...
    class MachinePartFactory {
        ...
        createTrack(partName, prop) {
            ...
            if (partName === "pixel") {
                return new MarbleRunSimulatorCore.Pixel(this.machine, prop);
            }
...
(function (MarbleRunSimulatorCore) {
    ...
    PipeTrack.PIPE_OFFSET_OVER_BASETRACK = 0.0085;
    ...
    class SleeperMeshBuilder {
        static GenerateSleepersVertexData(part, props) {
            ...
            for (let j = 0; j < part.tracks.length; j++) {
                ...
                if (part.game.materials.getMaterialType(colorIndex) === MarbleRunSimulatorCore.MaterialType.Plastic && part.machine.toonOutlineRender) {
...
(function (MarbleRunSimulatorCore) {
    ...
    class TrackTemplate {
        constructor(partTemplate) {
            ...
            this.colorIndex = 0;
            this.isPipe = false;
            this.pipeIgnoresTrackNormals = false;
            this.isWood = false;
            this.isDouble = false;
            this.summedLength = [0];
            this.totalLength = 0;
    ...
    class TemplateManager {
        ...
        getTemplate(partName, mirror, mirrorZ) {
            ...
            if (!data) {
                if (partName.startsWith("curb_")) {
                    ...
                    data = MarbleRunSimulatorCore.Pixel.GenerateTemplate();
                }
        ...
        getTemplateByProp(baseName, prop) {
            ...
            if (baseName === "curb") {
                ...
                partName = MarbleRunSimulatorCore.Pixel.PropToPartName(prop);
            }
...
(function (MarbleRunSimulatorCore) {
    ...
    UI3DConstants.outlineHoverColor = new BABYLON.Color3(0.7, 0.7, 0.7);
    UI3DConstants.outlineSelectedColor = new BABYLON.Color3(1, 1, 1);
    UI3DConstants.toonOutlineWidth = 0.001;
    UI3DConstants.toonOutlineBaseColor = new BABYLON.Color3(0, 0, 0);
...
(function (MarbleRunSimulatorCore) {
    class WoodTrackMeshBuilder {
        static async BuildWoodTrackMesh(track, props) {
            ...
            track.mesh.parent = track.part;
            track.mesh.material = track.part.game.materials.getMaterial(track.part.getColor(0), track.part.machine.materialQ);
            let W = 3 * MarbleRunSimulatorCore.tileSize + 0.01;
            let w = 3 * MarbleRunSimulatorCore.tileSize;
            let W05 = W * 0.5;
            let w05 = w * 0.5;
            let H = 0.015;
            let h = 0.01;
...
(function (MarbleRunSimulatorCore) {
    ...
    LargeBitSplit.boxRadius = 0.9 * MarbleRunSimulatorCore.tileSize;
...
(function (MarbleRunSimulatorCore) {
            ...
            if (this.hovered || this.selected) {
                this.outlinableMeshes.forEach(mesh => {
                    if (mesh instanceof BABYLON.Mesh) {
                        ...
                        mesh.outlineWidth = MarbleRunSimulatorCore.UI3DConstants.outlineWidth;
                        if (this.selected) {
                            mesh.outlineColor.copyFrom(MarbleRunSimulatorCore.UI3DConstants.outlineSelectedColor);
                        }
                        else if (this.hovered) {
                            mesh.outlineColor.copyFrom(MarbleRunSimulatorCore.UI3DConstants.outlineHoverColor);
                        }
                    }
                });
            }
                ...
                this.outlinableMeshes.forEach(mesh => {
                    if (mesh instanceof BABYLON.Mesh) {
                        if (this.blackboard.machine.toonOutlineRender) {
                            MarbleRunSimulatorCore.MainMaterials.SetAsOutlinedMesh(mesh);
                        }
                        else {
    ...
    MarbleRunSimulatorCore.BlackBoardElement = BlackBoardElement;
    ...
    export class BBTrampoline extends BlackBoardElement {
        ...
        public contactNormal: BABYLON.Vector3;
        public bouncingPoint: BABYLON.Vector3;
        public bouncingPointVelocity: BABYLON.Vector3 = BABYLON.Vector3.Zero();
        ...
        public getBouncyness(ball: Ball): number {
        ...
        constructor(
            ...
            if (this.blackboard.machine.toonOutlineRender) {
                ...
                MainMaterials.SetAsOutlinedMesh(tip0);
                MainMaterials.SetAsOutlinedMesh(tip1);
            }
    ...
    class BBBouncer extends BlackBoardElement {
        ...
        updateMesh() {
            ...
            let bodyData = Mummu.CreateBeveledBoxVertexData({
                ...
                depth: MarbleRunSimulatorCore.tileSize * 0.7
            });
            ...
            let plateData = Mummu.CreateBeveledBoxVertexData({
                width: l - 0.004,
                height: 0.002,
                depth: MarbleRunSimulatorCore.tileSize * 0.7 - 0.004
            });
            if (!this.plateTop) {
    ...
    class BlackBoard extends MarbleRunSimulatorCore.MachinePart {
        ...
        async instantiate(rebuildNeighboursWireMeshes, skipSleepersAndSupport) {
            ...
            for (let i = 0; i < this.lines.length; i++) {
                ...
                let track = this.tracks[i];
                if (track instanceof MarbleRunSimulatorCore.DoubleTrack) {
        ...
        getLineIndexAt(localPosition, range = 0.01) {
            let bestDist = range;
            let bestIndex = -1;
            let proj = {
                point: BABYLON.Vector3.Zero(),
        ...
        getBouncerIndexAt(localPosition, range = 0.01) {
            let bestDist = range;
            let bestIndex = -1;
...
(function (MarbleRunSimulatorCore) {
    ...
    Ladder._WallThickness = 0.005;
    Ladder._WallDepth = 0.02;
    Ladder._Drop = 0.01;
...
/*
    Pixel has an obvious problem : it's too big.
*/
var MarbleRunSimulatorCore;
(function (MarbleRunSimulatorCore) {
    class Pixel extends MarbleRunSimulatorCore.MachinePart {
        constructor(machine, prop) {
            super(machine, prop);
            this.setColorCount(2);
            this.setTemplate(this.machine.templateManager.getTemplate(Pixel.PropToPartName(prop)));
            let rShield = 0.0095;
            let hShield = 0.008;
            let shieldWire = new MarbleRunSimulatorCore.Wire(this);
            shieldWire.colorIndex = 0;
            ...
            this.shieldConnector.parent = this;
            Mummu.MergeVertexDatas(...vDatas).applyToMesh(this.shieldConnector);
            this.screenMesh = Mummu.CreateBeveledBox("screen", {
                width: 2 * MarbleRunSimulatorCore.tileSize - 0.002,
                height: 2 * MarbleRunSimulatorCore.tileHeight - 0.002,
                depth: 0.003,
            });
            this.screenMesh.position.x = MarbleRunSimulatorCore.tileSize * 0.5;
            this.screenMesh.position.y = -MarbleRunSimulatorCore.tileHeight * 0.5;
            this.screenMesh.position.z = MarbleRunSimulatorCore.tileSize * 0.5;
            this.screenMesh.rotation.y = Math.PI * 0.5;
        ...
        static GenerateTemplate() {
            ...
            template.trackTemplates[1].colorIndex = 1;
            template.trackTemplates[1].trackpoints = [
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(r, -MarbleRunSimulatorCore.tileHeight + 0.004, 0), (new BABYLON.Vector3(-1, -0.4, 0)).normalize()),
                new MarbleRunSimulatorCore.TrackPoint(template.trackTemplates[1], new BABYLON.Vector3(-MarbleRunSimulatorCore.tileSize * 0.5, -MarbleRunSimulatorCore.tileHeight, 0), new BABYLON.Vector3(-1, 0, 0))
            ];
            template.trackTemplates[1].drawStartTip = true;
            template.maxAngle = 0;
            template.defaultAngle = 0;
    ...
    MarbleRunSimulatorCore.Pixel = Pixel;
})(MarbleRunSimulatorCore || (MarbleRunSimulatorCore = {}));
var MarbleRunSimulatorCore;
(function (MarbleRunSimulatorCore) {
    class Ramp extends MarbleRunSimulatorCore.MachinePart {
        constructor(machine, prop) {
            ...
            if (prop.woodVersion) {
                this.localAABBBaseMin.z = -3 * MarbleRunSimulatorCore.tileSize;
                this.localAABBBaseMax.z = 2 * MarbleRunSimulatorCore.tileSize;
            }
            this.generateWires();
        }
        static PropToPartName(prop) {
...
(function (MarbleRunSimulatorCore) {
    class Sort extends MarbleRunSimulatorCore.MachinePart {
        constructor(machine, prop) {
            ...
            this.anchor.rotation.z = Math.PI / 4;
            this.anchor.parent = this;
            this.pivot = new BABYLON.Mesh("pivot");
            this.pivot.position.copyFromFloats(0, -MarbleRunSimulatorCore.tileHeight * 0.5, 0);
            this.pivot.parent = this;
            ...
            this.outlinableMeshes = [this.anchor, this.panel, this.panelSupport, this.panelPicture];
            this.generateWires();
            this._animatePivot = Mummu.AnimationFactory.CreateNumber(this, this.pivot.rotation, "z", () => {
                if (!this.machine.playing) {
                    this.pivot.rotation.z = (this.mirrorZ ? -1 : 1) * Math.PI / 4;
        ...
        async instantiateMachineSpecific() {
            ...
            let panelData = await this.game.vertexDataLoader.get("./lib/marble-run-simulator-core/datas/meshes/panel.babylon");
            panelData[0].applyToMesh(this.panel);
            this.panel.material = this.game.materials.getMaterial(this.getColor(4), this.machine.materialQ);
            panelData[1].applyToMesh(this.panelSupport);
            this.panelSupport.material = this.game.materials.getMaterial(this.getColor(2), this.machine.materialQ);
            panelData[2].applyToMesh(this.panelPicture);
            this.panelPicture.material = this.game.materials.getBallMaterial(this.game.materials.baseMaterialIndexToBallMaterialIndex(this.getColor(0)), this.machine.materialQ);
        }
            ...
            if (!this._moving) {
                for (let i = 0; i < this.machine.balls.length; i++) {
                    ...
                    if (BABYLON.Vector3.Distance(ball.position, this.pivot.absolutePosition) < 0.05) {
                        ...
                        if (local.y < 0.08) {
                            let sortBallMaterialIndex = this.game.materials.baseMaterialIndexToBallMaterialIndex(this.getColor(0));
                            let exitLeft = true;
