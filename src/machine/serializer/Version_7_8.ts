namespace MarbleRunSimulatorCore {
    ...
    export function DeserializeV78(machine: Machine, data: IMachineData, makeMiniature: boolean = false, canvas?: HTMLCanvasElement, miniatureProps?: IMiniatureProps): void {
