namespace MarbleRunSimulatorCore {
    ...
    export function DeserializeV910(machine: Machine, data: IMachineData, makeMiniature: boolean = false, canvas?: HTMLCanvasElement, miniatureProps?: IMiniatureProps): void {
