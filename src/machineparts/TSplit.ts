namespace MarbleRunSimulatorCore {
    export class TSplit extends MachinePart {
        ...
        public static GenerateTemplate() {
            ...
            template.trackTemplates[0].trackpoints = [
                ...
                new TrackPoint(template.trackTemplates[0], pEndLeft, dirEnd)
            ];
            ...
            template.trackTemplates[1].trackpoints = [
                new TrackPoint(template.trackTemplates[1],
                    new BABYLON.Vector3(0, -tileHeight * 0.5 - Split.pivotL / Math.SQRT2 - 0.0005, Split.pivotL / Math.SQRT2),
                    Mummu.RotateInPlace(Tools.V3Dir(115), BABYLON.Axis.Y, - Math.PI * 0.5),
                    BABYLON.Vector3.Up()
                ), 
                new TrackPoint(template.trackTemplates[1],
                    new BABYLON.Vector3(0, -tileHeight * template.h, 0.5 * tileWidth),
            ...
            template.trackTemplates[3].trackpoints = [
                new TrackPoint(template.trackTemplates[3],
                    new BABYLON.Vector3(-tileWidth * 0.5 + 0.01, 0.016, 0),
                    dir,
