namespace MarbleRunSimulatorCore {
    export class Cross2D extends MachinePart {
        ...
        public static GenerateTemplate(): MachinePartTemplate {
            ...
            template.trackTemplates[2].trackpoints = [
                new TrackPoint(template.trackTemplates[2], new BABYLON.Vector3(- tileWidth * 0.5, - tileHeight, 0), Tools.V3Dir(90)),
                new TrackPoint(template.trackTemplates[2], new BABYLON.Vector3(0, - tileHeight + 0.005, 0), Tools.V3Dir(90)),
                new TrackPoint(template.trackTemplates[2], new BABYLON.Vector3(tileWidth * 0.5, - tileHeight, 0), Tools.V3Dir(90)),
            ];
