namespace MarbleRunSimulatorCore {
    ...
    export class DropSide extends MachinePart {
        ...
        public static GenerateTemplate(h: number, mirror: boolean): MachinePartTemplate {
            ...
            template.trackTemplates[1].trackpoints = [
                ...
                new TrackPoint(
                    template.trackTemplates[1],
                    new BABYLON.Vector3(0, - tileHeight * template.h, tileSize * 0.5),
